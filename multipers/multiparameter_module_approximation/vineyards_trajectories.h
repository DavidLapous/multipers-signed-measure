...
// boundary_matrix simplex_tree_to_boundary_matrix(Gudhi::Simplex_tree<> &simplexfiltration_value_typeree);
...
// 				filtration_value_typehis is a WIP; as this imply more memory operations, this is
                    ...
                    const point_type& basepoint)
{
    ...
    if (point >= box.get_bottom_corner()) return;
